...
function TypeaheadFK(props) {
    ...
    const [fkId, setFkId] = (0, kore_hooks_1.useObservable)(props.fkId);
    const [docObs] = (0, react_1.useState)(() => (0, knockout_1.observable)());
    const [doc, setDoc] = (0, kore_hooks_1.useObservable)(docObs);
    (0, kore_hooks_1.useObservable)(props.options);
