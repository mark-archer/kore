...
function Autogrid(params) {
    ...
    const newRowCount = (0, kore_hooks_1.useObservableState)(0);
    let _newRow;
    ...
    const [_data, setData] = (0, kore_hooks_1.useObservable)(obsData);
    ...
    const [searchText] = (0, kore_hooks_1.useObservable)(params.searchText);
