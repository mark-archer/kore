...
const kore_hooks_1 = require("./kore-hooks");
const typeahead_fk_1 = require("./typeahead-fk");
const input_number_1 = require("./input-number");
exports.sortCache = (0, kore_hooks_1.persistentValue)({}, 'datagridSortCache');
function Datagrid(params) {
    ...
    const sortFields = (0, kore_hooks_1.useObservableArrayState)(_defaultSort);
...
const DataRow = react_1.default.memo(function ({ rowData, columns, primaryKey, iRow, cellState }) {
    let [validationError] = (0, kore_hooks_1.useObservable)(rowData.validationError);
...
const DataCell = react_1.default.memo(function ({ doc, column, iCol, iRow, cellState }) {
    ...
    if (!sub) {
        ...
        if (doc.q) {
            (0, kore_hooks_1.useObservable)(doc.q);
        }
    }
    (0, kore_hooks_1.useObservable)(sub);
    ...
    let [value, setValue] = (0, kore_hooks_1.useObservable)(sub);
