...
function LazySortableList(props) {
    return (react_1.default.createElement(lazy_list_1.LazyList, { loadMore: props.loadMore, filterItems: props.filterItems, endOfList: props.endOfList, loadingIndicator: props.loadingIndicator, scrollThreshold: props.scrollThreshold, renderItems: items => (react_1.default.createElement(sortable_list_1.SortableList, { items: items, sortDirection: props.sortDirection, renderItem: props.renderItem, listsGroup: props.listsGroup, onAdd: props.onAdd, onUpdate: props.onUpdate, hidden: props.hidden, containerProps: props.containerProps, dragHandleClassName: props.dragHandleClassName, minHeight: props.minHeight, paddingBottom: props.paddingBottom })) }));
}
